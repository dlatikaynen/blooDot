...
namespace blooDot::World
{
	...
	void _Put(std::shared_ptr<WorldSheet> sheet, int x, int y, Ding ding, short pixX = 0, short pixY = 0, short angle = 0, short zIndex = 0, DingProps props = DingProps::Default);
}