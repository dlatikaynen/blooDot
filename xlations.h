...
constexpr char const* literalSettingsScreenModeXResolution = "720 x 348";
constexpr char const* literalSettingsScreenSVGA = "SVGA";
constexpr char const* literalSettingsScreenSVGAResolution = "720 x 348";
...
constexpr char const* literalSettingsScreenFullResolution = "{hPixels} x {vPixels}";
