...
namespace blooDot::fi
{
	...
	constexpr char const* _literal_fi_teleportPointNameMinusculeArray = "Lesser Array";
	constexpr char const* _literal_fi_teleportPointNameAverageArray = "Average Array";
	constexpr char const* _literal_fi_teleportPointNameGoldilocksArray = "Cromulent Array";
	...
	constexpr char const* _literal_fi_teleportPointNameStChungusArray = "St. Graham Chungus Memorial Array";
