...
namespace blooDot::fi
{
	...
	constexpr char const* _literal_fi_SettingsLanguageDEName = "Saksa";
	...
	constexpr char const* _literal_fi_teleportPointNameLargeArray = "Large Array";
	constexpr char const* _literal_fi_teleportPointNameVeryLargeArray = "Very Large Array";
	constexpr char const* _literal_fi_teleportPointNameEvenLargerArray = "Even Larger Array";
	constexpr char const* _literal_fi_teleportPointNameUltraLargeArray = "Ultra Large Array";
	constexpr char const* _literal_fi_teleportPointNameGinormousArray = "Ginormous Array";
	constexpr char const* _literal_fi_teleportPointNameCollossallyLargeArray = "Collossally Large Array";
	constexpr char const* _literal_fi_teleportPointNameSupercollossalArray = "Supercollossal Array";
	constexpr char const* _literal_fi_teleportPointNameJumboMamouthArray = "Jumbo Mamouth Array";
	constexpr char const* _literal_fi_teleportPointNameStChungusArray = "St. Chungus Hyperarray";
	constexpr char const* _literal_fi_teleportPointNameArrayOfIndeterminateSize = "Array of Indeterminate Size";
	...
	constexpr char const* _literal_fi_mainQuestTitleDrawing = "Vesinokkaeläinhäkinsuunnitelma";
