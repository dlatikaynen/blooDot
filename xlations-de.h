...
namespace blooDot::de
{
	...
	constexpr char const* _literal_de_SettingsLanguageEN = "[en]";
	constexpr char const* _literal_de_SettingsLanguageENDetails = "American";
	constexpr char const* _literal_de_SettingsLanguageENName = "English";
	...
	constexpr char const* _literal_de_SettingsLanguageFIName = "Finnish";
	constexpr char const* _literal_de_SettingsLanguageDE = "[de]";
	constexpr char const* _literal_de_SettingsLanguageDEDetails = "Deutsch";
	constexpr char const* _literal_de_SettingsLanguageDEName = "German";
	constexpr char const* _literal_de_SettingsLanguageUA = "[ua]";
	constexpr char const* _literal_de_SettingsLanguageUADetails = "Ukrayin'ska";
	constexpr char const* _literal_de_SettingsLanguageUAName = "Ukrainian";
	constexpr char const* _literal_de_Savegame = "Savegame";
	constexpr char const* _literal_de_SavegameBlank = "Initial";
	constexpr char const* _literal_de_SavepointSingular = "1 savepoint";
	constexpr char const* _literal_de_SavepointPlural = "$n savepoints";
	constexpr char const* _literal_de_Created = "created";
